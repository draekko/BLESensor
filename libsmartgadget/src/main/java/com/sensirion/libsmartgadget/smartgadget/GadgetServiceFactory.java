...
class GadgetServiceFactory {
    ...
    private void registerSmartGadgetServices() {
        ...
        // Tuya BLE Sensor with PVVX based BTHome firmware temperature and relative humidity sensor
        registerSmartGadgetService(BTHomeTuyaTemperatureHumidtyService.SERVICE_UUID, BTHomeTuyaTemperatureHumidtyService.class);
