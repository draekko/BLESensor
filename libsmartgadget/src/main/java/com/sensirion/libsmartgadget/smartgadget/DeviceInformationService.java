...
public class DeviceInformationService implements GadgetService, BleConnectorCallback {
    ...
    public static final String TAG = DeviceInformationService.class.getSimpleName();
